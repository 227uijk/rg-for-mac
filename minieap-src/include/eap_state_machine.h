...
/*
 * Best-effort: tell the server we are logging off, if we ever got far
 * enough to have a session worth telling about. Safe to call at any time,
 * including before init or after things are torn down.
 */
